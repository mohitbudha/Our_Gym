...
const Packages = () => {
  ...
  return (
    <section id="packages" className="py-16 px-6 bg-gray-100 text-center select-none caret-transparent">
      <h2 className="text-4xl font-bold text-black mb-10">OUR PACKAGES</h2>
